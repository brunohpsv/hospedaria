...
export const ShortcutsModal: React.FC<ShortcutsModalProps> = ({ isOpen = true, onClose }) => {
  ...
  const shortcuts = [
    { key: 'F1 ou ?', desc: 'Abrir esta tela de ajuda e atalhos de navegação rápida' },
    { key: 'F2 ou Alt+1', desc: 'Ir para Hóspedes & Fichas de Check-in' },
    { key: 'F3 ou Alt+2', desc: 'Ir para Controle de Quartos e Limpeza' },
    { key: 'F4 ou Alt+3', desc: 'Ir para Calendário e Mapa de Ocupação' },
    { key: 'F5 ou Alt+4', desc: 'Ir para Controle Financeiro & Faturamento Mensal' },
    { key: 'F6 ou Alt+5', desc: 'Ir para Tabela de Tarifas e Valores' },
    { key: 'F7 ou Alt+6', desc: 'Ir para Estoque & Almoxarifado' },
    { key: 'F8 ou Alt+7', desc: 'Ir para Equipe e Funcionários' },
    { key: 'F9 ou Alt+8', desc: 'Ir para Dados do Estabelecimento & Horários' },
    { key: 'F10', desc: 'Abrir modal de emissão de Comprovante TXT' },
    { key: 'Ctrl + N', desc: 'Iniciar novo cadastro de hóspede / formulário em branco' },
    { key: 'Ctrl + S', desc: 'Salvar dados no Firebase com persistência contínua' },
    { key: 'Ctrl + F', desc: 'Focar no campo de busca rápida superior' },
    { key: 'Alt + Q', desc: 'Sair do sistema e retornar à tela inicial de Login' },
    { key: 'Esc', desc: 'Fechar modais abertos ou limpar digitação' },
